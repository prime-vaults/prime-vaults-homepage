...
function TypographyCard({ className, name, font, type }: Props) {
  return (
    <div className="flex flex-col gap-4 p-8 border border-[#3E3E3E] font-medium text-[#FFF]">
      <p className="text-lg">{type}</p>
      <p className={`text-[64px] mt-12 ${className}`}>{name}</p>
      {font && (
  ...
  return (
    <div className="section-container grid grid-cols-2 gap-12">
      <div className="col-span-full flex flex-col gap-4">
        <p className="text-[100px] font-bold">TYPOGRAPHY</p>

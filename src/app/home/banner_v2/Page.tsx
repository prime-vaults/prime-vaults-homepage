...
export default function BannerV2Page() {
  return (
    <Container innerClassName="relative flex flex-col border-none">
      <div className="relative flex flex-row justify-between items-start gap-4 px-6">
        {/* vault - left side */}
        ...
        <div className="relative md:max-w-1/2 flex flex-col gap-4 pt-6 md:pt-24 z-20">
          <div className="flex flex-col gap-2 text-2xl md:text-5xl font-bold uppercase">
      ...
      {/* river */}
      <div className="relative w-10/12 -mt-16 mx-auto h-auto object-contain z-0">
        <River />
      </div>
      <Factory />
    </Container>
